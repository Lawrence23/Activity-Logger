  (function(){
    ...
    // var $listItem = $('ul li:last-child');
    // var act = $listItem.attr('id');
    mem = {};
    ...
    (function appendCanvas(){
        if(document.body)document.getElementById('act').appendChild(cvs);
    ...
    (function init(){
        new StopWatch();
        new Button(3,30,'START');
        new Button(63,30,'STOP');
        new Button(123,30,'RESET');
    })();
    (function loop(){
        var a
